...
async function getCreationDate () {
	...
	const res = await fetch(`https://www.udemy.com/api-2.0/courses/${courseId}/?fields[course]=created`).then(res => res.json()).then(res => res)
    const date = (new Date(res.created)).toLocaleDateString()
